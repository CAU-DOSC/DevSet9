...
public class IntSetListSimulator extends IntSetSimulator {
    ...
    private static IntSetList cachedList = null;
    ...
    private static IntSetList makeRandomList(Iterable<Integer> elements) {
        IntSetList list = new IntSetList(MAX_ELEMENT, MAX_VALUE);
